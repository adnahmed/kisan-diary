...
exports.links = exports.loader = void 0;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    user = _b.sent();
                    if (user)
                        return [2 /*return*/, redirect("/" + user.role)];
                    else
...
function LandingPage() {
    var _a = react_1.useDisclosure(), isOpenLogIn = _a.isOpen, onOpenLogIn = _a.onOpen, onCloseLogIn = _a.onClose;
    return (React.createElement("div", null,
        React.createElement("div", { className: "header" },
            ...
            React.createElement("div", { className: "menu" },
                React.createElement(react_2.Link, { to: "/join" },
                    React.createElement("div", { className: "join" }, "Sign Up")),
                React.createElement(react_2.Link, { to: "login" },
                    React.createElement("div", { onClick: onOpenLogIn, className: "login" }, "Log In")))),
        React.createElement(react_1.Modal, { blockScrollOnMount: false, isOpen: isOpenLogIn, onClose: onCloseLogIn },
            React.createElement(react_1.ModalOverlay, { bg: "none" }),
            React.createElement(react_1.ModalContent, null,
                React.createElement(react_1.ModalHeader, null, "Log In"),
                React.createElement(react_1.ModalCloseButton, null),
                React.createElement(react_1.ModalBody, null,
                    React.createElement(react_2.Outlet, null)))),
